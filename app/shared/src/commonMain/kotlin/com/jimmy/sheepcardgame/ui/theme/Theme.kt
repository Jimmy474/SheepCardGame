...
class CardGameTheme(
    val colorScheme: ColorScheme = lightScheme,
    val typography: Typography = Typography(),
    val shapes: Shapes = Shapes(),
)

val LocalCardGameTheme = staticCompositionLocalOf { CardGameTheme() }

val StyleScope.colorScheme: ColorScheme
    get() = LocalCardGameTheme.currentValue.colorScheme

val StyleScope.typography: Typography
    get() = LocalCardGameTheme.currentValue.typography

val StyleScope.shapes: Shapes
    get() = LocalCardGameTheme.currentValue.shapes